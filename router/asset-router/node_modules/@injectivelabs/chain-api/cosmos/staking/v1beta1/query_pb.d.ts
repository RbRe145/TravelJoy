...
import * as cosmos_base_query_v1beta1_pagination_pb from "@injectivelabs/chain-api/cosmos/base/query/v1beta1/pagination_pb";
...
import * as cosmos_staking_v1beta1_staking_pb from "@injectivelabs/chain-api/cosmos/staking/v1beta1/staking_pb";
...
export class QueryValidatorsResponse extends jspb.Message {
  ...
  setValidatorsList(value: Array<cosmos_staking_v1beta1_staking_pb.Validator>): void;
...
export class QueryValidatorDelegationsResponse extends jspb.Message {
  ...
  setDelegationResponsesList(value: Array<cosmos_staking_v1beta1_staking_pb.DelegationResponse>): void;
...
export class QueryValidatorUnbondingDelegationsResponse extends jspb.Message {
  ...
  setUnbondingResponsesList(value: Array<cosmos_staking_v1beta1_staking_pb.UnbondingDelegation>): void;
...
export class QueryDelegationRequest extends jspb.Message {
  ...
  setDelegatorAddr(value: string): void;
...
export class QueryDelegationResponse extends jspb.Message {
  ...
  setDelegationResponse(value?: cosmos_staking_v1beta1_staking_pb.DelegationResponse): void;
...
export class QueryUnbondingDelegationResponse extends jspb.Message {
  ...
  setUnbond(value?: cosmos_staking_v1beta1_staking_pb.UnbondingDelegation): void;
...
export class QueryRedelegationsRequest extends jspb.Message {
  ...
  setSrcValidatorAddr(value: string): void;

  getDstValidatorAddr(): string;
  setDstValidatorAddr(value: string): void;
...
export class QueryRedelegationsResponse extends jspb.Message {
  ...
  setRedelegationResponsesList(value: Array<cosmos_staking_v1beta1_staking_pb.RedelegationResponse>): void;
...
export class QueryHistoricalInfoResponse extends jspb.Message {
  ...
  setHist(value?: cosmos_staking_v1beta1_staking_pb.HistoricalInfo): void;
...
export class QueryPoolResponse extends jspb.Message {
  ...
  setPool(value?: cosmos_staking_v1beta1_staking_pb.Pool): void;
