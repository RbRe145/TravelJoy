...
import * as cosmos_proto_cosmos_pb from "@injectivelabs/chain-api/cosmos_proto/cosmos_pb";
...
export class AccessTypeParam extends jspb.Message {
  getValue(): AccessTypeMap[keyof AccessTypeMap];
  setValue(value: AccessTypeMap[keyof AccessTypeMap]): void;
...
export namespace AccessTypeParam {
  export type AsObject = {
    value: AccessTypeMap[keyof AccessTypeMap],
  }
}

export class AccessConfig extends jspb.Message {
  getPermission(): AccessTypeMap[keyof AccessTypeMap];
  setPermission(value: AccessTypeMap[keyof AccessTypeMap]): void;
...
export namespace AccessConfig {
  export type AsObject = {
    permission: AccessTypeMap[keyof AccessTypeMap],
    address: string,
  }
}
...
export class Params extends jspb.Message {
  ...
  setCodeUploadAccess(value?: AccessConfig): void;

  getInstantiateDefaultPermission(): AccessTypeMap[keyof AccessTypeMap];
  setInstantiateDefaultPermission(value: AccessTypeMap[keyof AccessTypeMap]): void;
...
export namespace Params {
  export type AsObject = {
    ...
    instantiateDefaultPermission: AccessTypeMap[keyof AccessTypeMap],
  }
}
...
export class CodeInfo extends jspb.Message {
  ...
  setInstantiateConfig(value?: AccessConfig): void;
...
export class ContractInfo extends jspb.Message {
  ...
  setCreated(value?: AbsoluteTxPosition): void;
  ...
  // @ts-ignore 
  setExtension(value?: google_protobuf_any_pb.Any): void;
...
export class ContractCodeHistoryEntry extends jspb.Message {
  getOperation(): ContractCodeHistoryOperationTypeMap[keyof ContractCodeHistoryOperationTypeMap];
  setOperation(value: ContractCodeHistoryOperationTypeMap[keyof ContractCodeHistoryOperationTypeMap]): void;
  ...
  setUpdated(value?: AbsoluteTxPosition): void;
...
export interface ContractCodeHistoryOperationTypeMap {
...
export const ContractCodeHistoryOperationType: ContractCodeHistoryOperationTypeMap;
