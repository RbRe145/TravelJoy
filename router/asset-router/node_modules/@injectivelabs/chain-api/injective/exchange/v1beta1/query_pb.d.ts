...
import * as google_api_annotations_pb from "@injectivelabs/chain-api/google/api/annotations_pb";
import * as injective_exchange_v1beta1_exchange_pb from "@injectivelabs/chain-api/injective/exchange/v1beta1/exchange_pb";
import * as injective_exchange_v1beta1_genesis_pb from "@injectivelabs/chain-api/injective/exchange/v1beta1/genesis_pb";
import * as injective_oracle_v1beta1_oracle_pb from "@injectivelabs/chain-api/injective/oracle/v1beta1/oracle_pb";
import * as gogoproto_gogo_pb from "@injectivelabs/chain-api/gogoproto/gogo_pb";
...
export class NinjaVaultInfosRequest extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): NinjaVaultInfosRequest.AsObject;
  static toObject(includeInstance: boolean, msg: NinjaVaultInfosRequest): NinjaVaultInfosRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: NinjaVaultInfosRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): NinjaVaultInfosRequest;
  static deserializeBinaryFromReader(message: NinjaVaultInfosRequest, reader: jspb.BinaryReader): NinjaVaultInfosRequest;
}

export namespace NinjaVaultInfosRequest {
  export type AsObject = {
  }
}

export class NinjaVaultInfosResponse extends jspb.Message {
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): NinjaVaultInfosResponse.AsObject;
  static toObject(includeInstance: boolean, msg: NinjaVaultInfosResponse): NinjaVaultInfosResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: NinjaVaultInfosResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): NinjaVaultInfosResponse;
  static deserializeBinaryFromReader(message: NinjaVaultInfosResponse, reader: jspb.BinaryReader): NinjaVaultInfosResponse;
}

export namespace NinjaVaultInfosResponse {
  export type AsObject = {
