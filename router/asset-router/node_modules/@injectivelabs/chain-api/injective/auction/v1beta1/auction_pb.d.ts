...
import * as cosmos_base_v1beta1_coin_pb from "@injectivelabs/chain-api/cosmos/base/v1beta1/coin_pb";
...
export class EventAuctionStart extends jspb.Message {
  getRound(): number;
  setRound(value: number): void;

  getEndingTimestamp(): number;
  setEndingTimestamp(value: number): void;

  clearNewBasketList(): void;
  getNewBasketList(): Array<cosmos_base_v1beta1_coin_pb.Coin>;
  setNewBasketList(value: Array<cosmos_base_v1beta1_coin_pb.Coin>): void;
  addNewBasket(value?: cosmos_base_v1beta1_coin_pb.Coin, index?: number): cosmos_base_v1beta1_coin_pb.Coin;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): EventAuctionStart.AsObject;
  static toObject(includeInstance: boolean, msg: EventAuctionStart): EventAuctionStart.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: EventAuctionStart, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): EventAuctionStart;
  static deserializeBinaryFromReader(message: EventAuctionStart, reader: jspb.BinaryReader): EventAuctionStart;
}

export namespace EventAuctionStart {
  export type AsObject = {
    round: number,
    endingTimestamp: number,
    newBasketList: Array<cosmos_base_v1beta1_coin_pb.Coin.AsObject>,
  }
}
