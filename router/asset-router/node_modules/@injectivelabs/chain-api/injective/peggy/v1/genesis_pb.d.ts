...
import * as injective_peggy_v1_types_pb from "@injectivelabs/chain-api/injective/peggy/v1/types_pb";
import * as injective_peggy_v1_msgs_pb from "@injectivelabs/chain-api/injective/peggy/v1/msgs_pb";
import * as injective_peggy_v1_batch_pb from "@injectivelabs/chain-api/injective/peggy/v1/batch_pb";
import * as injective_peggy_v1_attestation_pb from "@injectivelabs/chain-api/injective/peggy/v1/attestation_pb";
...
export class GenesisState extends jspb.Message {
  ...
  clearEthereumBlacklistList(): void;
  getEthereumBlacklistList(): Array<string>;
  setEthereumBlacklistList(value: Array<string>): void;
  addEthereumBlacklist(value: string, index?: number): string;
...
export namespace GenesisState {
  export type AsObject = {
    ...
    ethereumBlacklistList: Array<string>,
  }
}
