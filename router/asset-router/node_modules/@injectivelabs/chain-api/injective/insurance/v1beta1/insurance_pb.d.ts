...
export class EventUnderwrite extends jspb.Message {
  getUnderwriter(): string;
  setUnderwriter(value: string): void;
  ...
  hasShares(): boolean;
  clearShares(): void;
  getShares(): cosmos_base_v1beta1_coin_pb.Coin | undefined;
  setShares(value?: cosmos_base_v1beta1_coin_pb.Coin): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): EventUnderwrite.AsObject;
  static toObject(includeInstance: boolean, msg: EventUnderwrite): EventUnderwrite.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: EventUnderwrite, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): EventUnderwrite;
  static deserializeBinaryFromReader(message: EventUnderwrite, reader: jspb.BinaryReader): EventUnderwrite;
}

export namespace EventUnderwrite {
  export type AsObject = {
    underwriter: string,
    marketid: string,
    deposit?: cosmos_base_v1beta1_coin_pb.Coin.AsObject,
    shares?: cosmos_base_v1beta1_coin_pb.Coin.AsObject,
  }
}
