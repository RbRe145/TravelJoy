...
import { ValidatorRewards } from '@injectivelabs/sdk-ts/src/client/chain/types';
/**
 * @category Chain Grpc API
 */
export declare class ChainGrpcDistributionApi extends BaseConsumer {
    protected module: string;
    fetchModuleParams(): Promise<import("@injectivelabs/sdk-ts/src/client/chain/types").DistributionModuleParams>;
