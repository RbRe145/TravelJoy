import { SpotMarketInfo as GrpcSpotMarketInfo, SpotLimitOrder as GrpcSpotLimitOrder, SpotTrade as GrpcSpotTrade, SpotOrderHistory as GrpcSpotOrderHistory } from '@injectivelabs/indexer-api/injective_spot_exchange_rpc_pb';
...
import { PriceLevel } from '@injectivelabs/sdk-ts/src/client/indexer/types/exchange';
import { TokenMeta } from '@injectivelabs/token-metadata';
export declare enum SpotOrderSide {
...
export declare enum SpotOrderState {
    Unfilled = "unfilled",
    Booked = "booked",
...
export { GrpcSpotMarketInfo, GrpcSpotLimitOrder, GrpcSpotOrderHistory, GrpcSpotTrade, };
