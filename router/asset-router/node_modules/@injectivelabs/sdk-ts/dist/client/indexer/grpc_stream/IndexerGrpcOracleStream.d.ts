import { StreamPricesResponse, StreamPricesByMarketsResponse } from '@injectivelabs/indexer-api/injective_oracle_rpc_pb';
...
import { IndexerOracleStreamTransformer } from '@injectivelabs/sdk-ts/src/client/indexer/transformers/IndexerOracleStreamTransformer';
...
export declare class IndexerGrpcOracleStream {
    ...
    }): import("@injectivelabs/indexer-api/injective_oracle_rpc_pb_service").ResponseStream<StreamPricesResponse>;
    streamOraclePricesByMarkets({ marketIds, callback, onEndCallback, onStatusCallback, }: {
        ...
        onEndCallback?: (status?: StreamStatusResponse) => void;
        onStatusCallback?: (status: StreamStatusResponse) => void;
    }): import("@injectivelabs/indexer-api/injective_oracle_rpc_pb_service").ResponseStream<StreamPricesByMarketsResponse>;
}
//# sourceMappingURL=IndexerGrpcOracleStream.d.ts.map