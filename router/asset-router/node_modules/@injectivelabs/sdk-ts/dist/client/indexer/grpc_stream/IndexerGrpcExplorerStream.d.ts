...
import { StreamBlocksResponse, StreamTxsResponse } from '@injectivelabs/indexer-api/injective_explorer_rpc_pb';
import { StreamStatusResponse } from '@injectivelabs/sdk-ts/src/client/indexer/types';
import { ExplorerStreamTransformer } from '@injectivelabs/sdk-ts/src/client/indexer/transformers';
...
export declare class IndexerGrpcExplorerStream {
    ...
    }): import("@injectivelabs/indexer-api/injective_explorer_rpc_pb_service").ResponseStream<StreamBlocksResponse>;
    ...
    streamTransactions({ callback, onEndCallback, onStatusCallback, }: {
        ...
        onEndCallback?: (status?: StreamStatusResponse) => void;
        onStatusCallback?: (status: StreamStatusResponse) => void;
    }): import("@injectivelabs/indexer-api/injective_explorer_rpc_pb_service").ResponseStream<StreamTxsResponse>;
}
//# sourceMappingURL=IndexerGrpcExplorerStream.d.ts.map