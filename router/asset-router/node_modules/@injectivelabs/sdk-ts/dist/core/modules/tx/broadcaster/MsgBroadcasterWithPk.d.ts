import { PrivateKey } from '@injectivelabs/sdk-ts/src/core/accounts';
...
export declare class MsgBroadcasterWithPk {
     ...
     */
    broadcast(transaction: MsgBroadcasterTxOptions): Promise<import("@injectivelabs/sdk-ts/src/core/modules/tx").TxResponse>;
    /**
     * Broadcasting the transaction using the client
     *
     * @param tx
     * @returns {string} transaction hash
     */
    simulate(transaction: MsgBroadcasterTxOptions): Promise<import("@injectivelabs/sdk-ts/src/core/modules/tx").TxClientSimulateResponse>;
}
export {};
