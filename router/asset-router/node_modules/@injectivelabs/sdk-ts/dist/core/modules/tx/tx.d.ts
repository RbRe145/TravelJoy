...
import { CreateTransactionArgs, CreateTransactionResult, CreateTransactionWithSignersArgs } from '@injectivelabs/sdk-ts/src/core/modules/tx/types';
import { DirectSignResponse } from '@cosmjs/proto-signing';
import { Msgs } from '@injectivelabs/sdk-ts/src/core';
 ...
 * @returns TxRaw
 */
export declare const createTxRawFromSigResponse: (response: TxRaw | DirectSignResponse) => TxRaw;
/**
...
export declare const createTransactionAndCosmosSignDoc: (args: CreateTransactionArgs) => {
    ...
    signers: import("@injectivelabs/sdk-ts/src/core/modules/tx/types").SignerDetails | import("@injectivelabs/sdk-ts/src/core/modules/tx/types").SignerDetails[];
    signer: import("@injectivelabs/sdk-ts/src/core/modules/tx/types").SignerDetails;
