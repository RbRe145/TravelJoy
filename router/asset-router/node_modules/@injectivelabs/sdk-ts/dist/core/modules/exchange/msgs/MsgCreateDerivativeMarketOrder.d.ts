...
export declare namespace MsgCreateDerivativeMarketOrder {
    ...
    type Proto = BaseMsgCreateDerivativeMarketOrder;
    type Object = BaseMsgCreateDerivativeMarketOrder.AsObject;
}
/**
 * @category Messages
 */
export default class MsgCreateDerivativeMarketOrder extends MsgBase<MsgCreateDerivativeMarketOrder.Params, MsgCreateDerivativeMarketOrder.Proto, MsgCreateDerivativeMarketOrder.Object> {
    static fromJSON(params: MsgCreateDerivativeMarketOrder.Params): MsgCreateDerivativeMarketOrder;
    toProto(): BaseMsgCreateDerivativeMarketOrder;
    toData(): {
        sender: string;
