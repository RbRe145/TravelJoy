...
import { TxClientBroadcastOptions, TxConcreteApi } from '@injectivelabs/sdk-ts/src/core/modules/tx/types/tx';
import { TxResponse } from '@injectivelabs/sdk-ts/src/core/modules/tx/types/tx';
/**
...
export declare class TxRestApi implements TxConcreteApi {
    ...
    broadcastBlock(tx: TxRaw): Promise<{
        ...
        gasUsed: number;
        height: number;
        logs: import("@injectivelabs/sdk-ts/src/core/modules/tx/types/tx-rest-client").RestTxLog[];
        code: number;
        codespace: string;
        data: string;
        info: string;
