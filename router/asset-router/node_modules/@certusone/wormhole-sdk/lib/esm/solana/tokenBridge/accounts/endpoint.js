    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return EndpointRegistration.deserialize(getAccountData(info)); })];
        });
    });
}
var EndpointRegistration = /** @class */ (function () {
    function EndpointRegistration(chain, contract) {
        this.chain = chain;
        this.contract = contract;
    }
    EndpointRegistration.deserialize = function (data) {
        if (data.length != 34) {
            throw new Error("data.length != 34");
        }
        var chain = data.readUInt16LE(0);
        var contract = data.subarray(2, 34);
        return new EndpointRegistration(chain, contract);
    };
    return EndpointRegistration;
}());
export { EndpointRegistration };
