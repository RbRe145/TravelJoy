...
export function createTransferNativeInstruction(tokenBridgeProgramId, wormholeProgramId, payer, message, from, mint, nonce, amount, fee, targetAddress, targetChain) {
    var methods = createReadOnlyTokenBridgeProgramInterface(tokenBridgeProgramId).methods.transferNative(nonce, amount, fee, Buffer.from(targetAddress), targetChain);
    // @ts-ignore
