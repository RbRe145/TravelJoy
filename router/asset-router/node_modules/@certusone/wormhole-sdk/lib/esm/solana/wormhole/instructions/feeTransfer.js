...
export function createBridgeFeeTransferInstruction(connection, wormholeProgramId, payer, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getWormholeBridgeData(connection, wormholeProgramId, commitment).then(function (data) { return data.config.fee; })];
                case 1:
                    fee = _a.sent();
                    return [2 /*return*/, SystemProgram.transfer({
