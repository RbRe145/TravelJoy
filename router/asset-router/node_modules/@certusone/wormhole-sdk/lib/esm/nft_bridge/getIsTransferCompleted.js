        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    signedVAAHash = getSignedVAAHash(signedVAA);
...
export function getIsTransferCompletedSolana(nftBridgeAddress, signedVAA, connection, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        var parsed;
        return __generator(this, function (_a) {
            parsed = parseVaa(signedVAA);
            return [2 /*return*/, getClaim(connection, nftBridgeAddress, parsed.emitterAddress, parsed.emitterChain, parsed.sequence, commitment).catch(function (e) { return false; })];
        });
    });
}
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    transferVaaHash = getSignedVAAHash(transferVaa);
                    _b.label = 2;
                case 2:
                    _b.trys.push([2, 4, , 5]);
