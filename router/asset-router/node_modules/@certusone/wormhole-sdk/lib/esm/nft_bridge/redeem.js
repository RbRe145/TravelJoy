...
export function redeemOnEth(nftBridgeAddress, signer, signedVAA, overrides) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    bridge = Bridge__factory.connect(nftBridgeAddress, signer);
...
export function isNFTVAASolanaNative(signedVAA) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, parseVaa(signedVAA).payload.readUInt16BE(33) === CHAIN_ID_SOLANA];
        });
    });
}
export function redeemOnSolana(connection, bridgeAddress, nftBridgeAddress, payerAddress, signedVaa, toAuthorityAddress, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parsed = parseNftTransferVaa(signedVaa);
                    createCompleteTransferInstruction = parsed.tokenChain == CHAIN_ID_SOLANA
                        ? createCompleteTransferNativeInstruction
                        : createCompleteTransferWrappedInstruction;
                    transaction = new Transaction().add(createCompleteTransferInstruction(nftBridgeAddress, bridgeAddress, payerAddress, parsed, toAuthorityAddress));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    transaction = new Transaction().add(createCompleteWrappedMetaInstruction(nftBridgeAddress, bridgeAddress, payerAddress, parsed));
                    return [4 /*yield*/, connection.getLatestBlockhash(commitment)];
                case 1:
                    blockhash = (_a.sent()).blockhash;
                    transaction.recentBlockhash = blockhash;
...
export function redeemOnTerra(nftBridgeAddress, walletAddress, signedVAA) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new MsgExecuteContract(walletAddress, nftBridgeAddress, {
                    submit_vaa: {
...
export function redeemOnAptos(nftBridgeAddress, transferVAA) {
    return __awaiter(this, void 0, void 0, function () {
        var parsedVAA;
        return __generator(this, function (_a) {
            parsedVAA = parseNftTransferVaa(transferVAA);
