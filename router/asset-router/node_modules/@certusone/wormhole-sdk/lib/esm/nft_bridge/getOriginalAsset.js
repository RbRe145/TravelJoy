...
import { assertChain, CHAIN_ID_APTOS, CHAIN_ID_SOLANA, coalesceChainId, deriveCollectionHashFromTokenId, hex, deriveTokenHashFromTokenId, ensureHexPrefix, uint8ArrayToHex, } from "../utils";
 ...
 * @returns
 */
export function getOriginalAssetEth(nftBridgeAddress, provider, wrappedAddress, tokenId, lookupChain) {
    return __awaiter(this, void 0, void 0, function () {
        var isWrapped, token, chainId, assetAddress;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getIsWrappedAssetEth(nftBridgeAddress, provider, wrappedAddress)];
                case 1:
                    isWrapped = _a.sent();
 ...
 * @returns
 */
export function getOriginalAssetSolana(connection, nftBridgeAddress, mintAddress, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        var mint_1;
        return __generator(this, function (_a) {
            try {
                mint_1 = new PublicKey(mintAddress);
                return [2 /*return*/, getWrappedMeta(connection, nftBridgeAddress, mintAddress, commitment)
...
export function getOriginalAssetTerra(client, wrappedAddress, lookupChain) {
    return __awaiter(this, void 0, void 0, function () {
        var result, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
 ...
 * address.
 */
export function getOriginalAssetAptos(client, nftBridgeAddress, tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    e_2 = _d.sent();
                    if (!((e_2 instanceof Types.ApiError || e_2.errorCode === "resource_not_found") &&
                        e_2.status === 404)) {
                        throw e_2;
                    }
                    return [3 /*break*/, 3];
                case 3:
                    ...
                    return [4 /*yield*/, deriveCollectionHashFromTokenId(tokenId)];
                case 4:
                    _c.assetAddress = _d.sent();
                    _a = ensureHexPrefix;
                    _b = uint8ArrayToHex;
                    return [4 /*yield*/, deriveTokenHashFromTokenId(tokenId)];
