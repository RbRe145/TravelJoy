...
import { CHAIN_ID_INJECTIVE, ensureHexPrefix, coalesceModuleAddress, tryNativeToHexString, } from "../utils";
...
export function getIsWrappedAssetInjective(tokenBridgeAddress, client, assetAddress) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    hexified = tryNativeToHexString(assetAddress, "injective");
                    return [4 /*yield*/, getForeignAssetInjective(tokenBridgeAddress, client, CHAIN_ID_INJECTIVE, new Uint8Array(Buffer.from(hexified)))];
                case 1:
                    result = _a.sent();
                    if (result === null) {
                        return [2 /*return*/, false];
...
export var getIsWrappedAssetSol = getIsWrappedAssetSolana;
/**
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, client.getAccountResource(coalesceModuleAddress(assetFullyQualifiedType), tokenBridgeAddress + "::state::OriginInfo")];
                case 2:
                    // get origin info from asset address
                    _b.sent();
                    return [2 /*return*/, true];
