...
export var getEmitterAddressInjective = getEmitterAddressTerra;
export var getEmitterAddressXpla = getEmitterAddressTerra;
export function getEmitterAddressAlgorand(appId) {
    var appAddr = getApplicationAddress(appId);
    var decAppAddr = decodeAddress(appAddr).publicKey;
    var aa = uint8ArrayToHex(decAppAddr);
    return aa;
}
