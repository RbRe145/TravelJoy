 ...
 * @returns
 */
function signTransactionFactory() {
    var payers = [];
...
function modifySignTransaction(signTransaction) {
    var payers = [];
 ...
 */
function signSendAndConfirmTransaction(connection, payer, signTransaction, unsignedTransaction, options) {
 ...
 * 4. Confirm transaction.
 */
function sendAndConfirmTransactionsWithRetry(connection, signTransaction, payer, unsignedTransactions, maxRetries, options) {
