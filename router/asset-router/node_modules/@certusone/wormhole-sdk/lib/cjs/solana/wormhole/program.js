...
var wormhole_json_1 = __importDefault(require("../../anchor-idl/wormhole.json"));
...
function createReadOnlyWormholeProgramInterface(programId, connection) {
    return createWormholeProgramInterface(programId, utils_1.createReadOnlyProvider(connection));
}
