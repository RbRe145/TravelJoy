...
var Secp256k1SignatureOffsets = /** @class */ (function () {
    ...
    Secp256k1SignatureOffsets.serialize = function (signatures, keys, message) {
        ...
        var dataLen = exports.SIGNATURE_LENGTH + exports.ETHEREUM_KEY_LENGTH; // 65 signature size + 20 eth pubkey size
        ...
        for (var i = 0; i < numSignatures; ++i) {
            ...
            if ((signature === null || signature === void 0 ? void 0 : signature.length) != exports.SIGNATURE_LENGTH) {
                throw Error("signatures[" + i + "].length != 65");
            }
            var key = keys.at(i);
            if ((key === null || key === void 0 ? void 0 : key.length) != exports.ETHEREUM_KEY_LENGTH) {
