...
function createBridgeFeeTransferInstruction(connection, wormholeProgramId, payer, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, accounts_1.getWormholeBridgeData(connection, wormholeProgramId, commitment).then(function (data) { return data.config.fee; })];
                case 1:
                    fee = _a.sent();
                    return [2 /*return*/, web3_js_1.SystemProgram.transfer({
                            fromPubkey: new web3_js_1.PublicKey(payer),
                            toPubkey: accounts_1.deriveFeeCollectorKey(wormholeProgramId),
                            lamports: fee,
                        })];
            }
        });
