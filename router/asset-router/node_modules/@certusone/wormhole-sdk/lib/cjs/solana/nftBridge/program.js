...
var nft_bridge_json_1 = __importDefault(require("../../anchor-idl/nft_bridge.json"));
...
function createReadOnlyNftBridgeProgramInterface(programId, connection) {
    return createNftBridgeProgramInterface(programId, utils_1.createReadOnlyProvider(connection));
}
