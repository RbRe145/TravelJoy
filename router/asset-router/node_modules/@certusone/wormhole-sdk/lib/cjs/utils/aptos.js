 ...
 */
var generateSignAndSubmitEntryFunction = function (client, sender, payload, opts) {
    return client
 ...
 * @returns Data from transaction after is has been successfully submitted to mempool
 */
var generateSignAndSubmitScript = function (client, sender, payload, opts) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                rawTx = new aptos_1.TxnBuilderTypes.RawTransaction(aptos_1.TxnBuilderTypes.AccountAddress.fromHex(sender.address()), BigInt(sequenceNumber), payload, BigInt(customOpts.max_gas_amount), BigInt(customOpts.gas_unit_price), BigInt(Math.floor(Date.now() / 1000) + 10), new aptos_1.TxnBuilderTypes.ChainId(chainId));
 ...
 */
var getAssetFullyQualifiedType = function (tokenBridgeAddress, originChain, originAddress) {
    // native asset
    ...
    var wrappedAssetAddress = exports.getForeignAssetAddress(tokenBridgeAddress, originChain, originAddress);
 ...
 */
var getForeignAssetAddress = function (tokenBridgeAddress, originChain, originAddress) {
    if (originChain === utils_2.CHAIN_ID_APTOS) {
        return null;
    }
 ...
 */
var isValidAptosType = function (str) {
 ...
 */
var getExternalAddressFromType = function (fullyQualifiedType) {
 ...
 */
var coalesceModuleAddress = function (str) {
    return str.split("::")[0];
};
 ...
 */
var deriveResourceAccountAddress = function (nftBridgeAddress, originChain, originAddress) { return __awaiter(void 0, void 0, void 0, function () {
    var originChainId, chainId, seed, resourceAccountAddress;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                originChainId = utils_2.coalesceChainId(originChain);
                ...
                return [4 /*yield*/, aptos_1.AptosAccount.getResourceAccountAddress(nftBridgeAddress, seed)];
            case 1:
 ...
 */
var deriveCollectionHashFromTokenId = function (tokenId) { return __awaiter(void 0, void 0, void 0, function () {
    var inputs;
    return __generator(this, function (_a) {
        ...
        return [2 /*return*/, new Uint8Array(Buffer.from(js_sha3_1.sha3_256(inputs), "hex"))];
    });
}); };
 ...
 */
var deriveTokenHashFromTokenId = function (tokenId) { return __awaiter(void 0, void 0, void 0, function () {
 ...
 * @returns Token ID
 */
var getTokenIdFromTokenHash = function (client, nftBridgeAddress, tokenHash) { return __awaiter(void 0, void 0, void 0, function () {
