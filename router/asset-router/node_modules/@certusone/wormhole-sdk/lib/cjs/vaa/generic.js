...
exports.encodeString = exports.encode = exports.typeWidth = exports.impossible = exports.sign = exports.vaaDigest = exports.serialiseVAA = exports.parseEnvelope = exports.assertKnownPayload = exports.parse = void 0;
...
// Parse a signature
var signatureParser = new binary_parser_1.Parser()
    .endianess("big")
...
var vaaParser = new binary_parser_1.Parser()
    .endianess("big")
    .uint8("version")
...
exports.serialiseVAA = serialiseVAA;
function vaaDigest(vaa) {
    return utils_1.solidityKeccak256(["bytes"], [utils_1.solidityKeccak256(["bytes"], ["0x" + vaaBody(vaa)])]);
}
exports.vaaDigest = vaaDigest;
...
var addressParser = function (length) {
    return new binary_parser_1.Parser().endianess("big").array("address", {
        type: "uint8",
...
var guardianSetUpgradeParser = new P(new binary_parser_1.Parser()
    .endianess("big")
    .string("module", {
    length: 32,
    encoding: "hex",
...
var coreContractUpgradeParser = new P(new binary_parser_1.Parser()
    .endianess("big")
    .string("module", {
    length: 32,
    encoding: "hex",
...
function portalContractUpgradeParser(module) {
    return new P(new binary_parser_1.Parser()
        .endianess("big")
        .string("module", {
        length: 32,
        encoding: "hex",
...
function tokenBridgeTransferParser() {
    return new P(new binary_parser_1.Parser()
        ...
        type: "uint8",
        lengthInBytes: 32,
        formatter: function (bytes) { return ethers_1.BigNumber.from(bytes).toBigInt(); },
    })
        .array("tokenAddress", {
        type: "uint8",
        lengthInBytes: 32,
...
function encode(type, val) {
    ...
    // digits in hex).
    return ethers_1.ethers.utils.defaultAbiCoder
        .encode([type], [val])
