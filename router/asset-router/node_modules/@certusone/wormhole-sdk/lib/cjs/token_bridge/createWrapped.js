...
exports.createWrappedOnAptos = exports.createWrappedTypeOnAptos = exports.createWrappedOnNear = exports.createWrappedOnAlgorand = exports.createWrappedOnSolana = exports.createWrappedOnXpla = exports.createWrappedOnInjective = exports.createWrappedOnTerra = exports.createWrappedOnEth = void 0;
...
exports.createWrappedOnInjective = redeem_1.submitVAAOnInjective;
...
function createWrappedOnSolana(connection, bridgeAddress, tokenBridgeAddress, payerAddress, signedVaa, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    transaction = new web3_js_1.Transaction().add(tokenBridge_1.createCreateWrappedInstruction(tokenBridgeAddress, bridgeAddress, payerAddress, signedVaa));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, utils_1.callFunctionNear(provider, tokenBridge, "deposit_estimates")];
                case 1:
                    res = _a.sent();
                    msgs = [
                        {
