...
import { ChainId, ChainName, CosmWasmChainId, CosmWasmChainName } from "@certusone/wormhole-sdk/lib/cjs/utils";
 ...
 */
export declare function getOriginalAssetAptos(client: AptosClient, tokenBridgeAddress: string, fullyQualifiedType: string): Promise<WormholeWrappedInfo>;
