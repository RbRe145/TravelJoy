...
interface GovernorVotesCompInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorVotesComp extends BaseContract {
  ...
  interface: GovernorVotesCompInterface;
