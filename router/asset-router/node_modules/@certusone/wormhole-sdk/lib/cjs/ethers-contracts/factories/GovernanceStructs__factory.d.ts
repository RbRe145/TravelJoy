...
import type { GovernanceStructs, GovernanceStructsInterface } from "@certusone/wormhole-sdk/lib/cjs/ethers-contracts/GovernanceStructs";
export declare class GovernanceStructs__factory extends ContractFactory {
    ...
    attach(address: string): GovernanceStructs;
    connect(signer: Signer): GovernanceStructs__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): GovernanceStructs;
}
