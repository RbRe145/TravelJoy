...
interface GovernorProposalThresholdInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorProposalThreshold extends BaseContract {
  ...
  interface: GovernorProposalThresholdInterface;
