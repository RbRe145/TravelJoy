...
import type { Wormhole, WormholeInterface } from "@certusone/wormhole-sdk/lib/cjs/ethers-contracts/Wormhole";
export declare class Wormhole__factory extends ContractFactory {
    constructor(signer?: Signer);
    deploy(setup: string, initData: BytesLike, overrides?: Overrides & {
        from?: string | Promise<string>;
    }): Promise<Wormhole>;
    getDeployTransaction(setup: string, initData: BytesLike, overrides?: Overrides & {
        from?: string | Promise<string>;
    }): TransactionRequest;
    attach(address: string): Wormhole;
    connect(signer: Signer): Wormhole__factory;
