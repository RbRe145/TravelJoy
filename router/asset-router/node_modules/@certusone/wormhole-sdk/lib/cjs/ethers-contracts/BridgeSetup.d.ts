...
interface BridgeSetupInterface extends ethers.utils.Interface {
  functions: {
    "setup(address,uint16,address,uint16,bytes32,address,address,uint8,uint256)": FunctionFragment;
  };
...
export class BridgeSetup extends BaseContract {
