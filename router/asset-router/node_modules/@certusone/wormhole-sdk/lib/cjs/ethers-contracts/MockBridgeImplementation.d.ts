...
interface MockBridgeImplementationInterface extends ethers.utils.Interface {
  functions: {
    ...
    "encodeTransferWithPayload(tuple)": FunctionFragment;
    ...
    "testUpdateWETHAddress(address)": FunctionFragment;
    "testOverwriteEVMChainId(uint16,uint256)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testUpdateWETHAddress",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "testOverwriteEVMChainId",
...
export class MockBridgeImplementation extends BaseContract {
  ...
  functions: {
    ...
    parseTransferWithPayload(
      ...
      [
        [number, BigNumber, string, number, string, number, string, string] & {
          payloadID: number;
          amount: BigNumber;
          tokenAddress: string;
          tokenChain: number;
