...
import { AccountView, AccessKeyView, AccessKeyInfoView, BlockReference } from 'near-api-js/lib/providers/provider';
...
export declare class Account {
     ...
     * @returns {Promise<any>}
     */
    viewFunction(...restArgs: any): Promise<any>;
    viewFunctionV1(contractId: string, methodName: string, args?: any, { parse, stringify, jsContract, blockQuery }?: {
        parse?: (response: Uint8Array) => any;
        stringify?: (input: any) => Buffer;
        blockQuery?: BlockReference;
        jsContract?: boolean;
