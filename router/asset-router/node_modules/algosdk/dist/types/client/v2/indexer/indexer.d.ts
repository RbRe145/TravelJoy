import ServiceClient from 'algosdk/dist/types/client/v2/serviceClient';
import MakeHealthCheck from 'algosdk/dist/types/client/v2/indexer/makeHealthCheck';
import LookupAssetBalances from 'algosdk/dist/types/client/v2/indexer/lookupAssetBalances';
import LookupAssetTransactions from 'algosdk/dist/types/client/v2/indexer/lookupAssetTransactions';
import LookupAccountTransactions from 'algosdk/dist/types/client/v2/indexer/lookupAccountTransactions';
import LookupBlock from 'algosdk/dist/types/client/v2/indexer/lookupBlock';
import LookupTransactionByID from 'algosdk/dist/types/client/v2/indexer/lookupTransactionByID';
import LookupAccountByID from 'algosdk/dist/types/client/v2/indexer/lookupAccountByID';
import LookupAccountAssets from 'algosdk/dist/types/client/v2/indexer/lookupAccountAssets';
import LookupAccountCreatedAssets from 'algosdk/dist/types/client/v2/indexer/lookupAccountCreatedAssets';
import LookupAccountAppLocalStates from 'algosdk/dist/types/client/v2/indexer/lookupAccountAppLocalStates';
import LookupAccountCreatedApplications from 'algosdk/dist/types/client/v2/indexer/lookupAccountCreatedApplications';
import LookupAssetByID from 'algosdk/dist/types/client/v2/indexer/lookupAssetByID';
import LookupApplications from 'algosdk/dist/types/client/v2/indexer/lookupApplications';
import LookupApplicationLogs from 'algosdk/dist/types/client/v2/indexer/lookupApplicationLogs';
import LookupApplicationBoxByIDandName from 'algosdk/dist/types/client/v2/indexer/lookupApplicationBoxByIDandName';
import SearchAccounts from 'algosdk/dist/types/client/v2/indexer/searchAccounts';
...
import SearchForApplicationBoxes from 'algosdk/dist/types/client/v2/indexer/searchForApplicationBoxes';
import { BaseHTTPClient } from 'algosdk/dist/types/client/baseHTTPClient';
import { CustomTokenHeader, IndexerTokenHeader } from 'algosdk/dist/types/client/urlTokenBaseHTTPClient';
/**
...
export default class IndexerClient extends ServiceClient {
     ...
     * @category GET
     */
    lookupAccountAssets(account: string): LookupAccountAssets;
    /**
     ...
     * @category GET
     */
    lookupAccountCreatedAssets(account: string): LookupAccountCreatedAssets;
    /**
     ...
     * @category GET
     */
    lookupAccountAppLocalStates(account: string): LookupAccountAppLocalStates;
    /**
     ...
     * @category GET
     */
    lookupAccountCreatedApplications(account: string): LookupAccountCreatedApplications;
    /**
     ...
     * @category GET
     */
    searchForApplicationBoxes(appID: number): SearchForApplicationBoxes;
    /**
     ...
     * @category GET
     */
    lookupApplicationBoxByIDandName(appID: number, boxName: Uint8Array): LookupApplicationBoxByIDandName;
}
