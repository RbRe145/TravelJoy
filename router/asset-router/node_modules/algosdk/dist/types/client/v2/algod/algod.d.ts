...
import * as modelsv2 from 'algosdk/dist/types/client/v2/algod/models/types';
import AccountInformation from 'algosdk/dist/types/client/v2/algod/accountInformation';
import AccountAssetInformation from 'algosdk/dist/types/client/v2/algod/accountAssetInformation';
import AccountApplicationInformation from 'algosdk/dist/types/client/v2/algod/accountApplicationInformation';
import Block from 'algosdk/dist/types/client/v2/algod/block';
import Compile from 'algosdk/dist/types/client/v2/algod/compile';
import Dryrun from 'algosdk/dist/types/client/v2/algod/dryrun';
import Genesis from 'algosdk/dist/types/client/v2/algod/genesis';
import GetAssetByID from 'algosdk/dist/types/client/v2/algod/getAssetByID';
import GetApplicationByID from 'algosdk/dist/types/client/v2/algod/getApplicationByID';
import GetBlockHash from 'algosdk/dist/types/client/v2/algod/getBlockHash';
import GetApplicationBoxByName from 'algosdk/dist/types/client/v2/algod/getApplicationBoxByName';
import GetApplicationBoxes from 'algosdk/dist/types/client/v2/algod/getApplicationBoxes';
import HealthCheck from 'algosdk/dist/types/client/v2/algod/healthCheck';
import PendingTransactionInformation from 'algosdk/dist/types/client/v2/algod/pendingTransactionInformation';
import PendingTransactions from 'algosdk/dist/types/client/v2/algod/pendingTransactions';
import PendingTransactionsByAddress from 'algosdk/dist/types/client/v2/algod/pendingTransactionsByAddress';
import GetTransactionProof from 'algosdk/dist/types/client/v2/algod/getTransactionProof';
import SendRawTransaction from 'algosdk/dist/types/client/v2/algod/sendRawTransaction';
import Status from 'algosdk/dist/types/client/v2/algod/status';
import StatusAfterBlock from 'algosdk/dist/types/client/v2/algod/statusAfterBlock';
import SuggestedParams from 'algosdk/dist/types/client/v2/algod/suggestedParams';
import Supply from 'algosdk/dist/types/client/v2/algod/supply';
import Versions from 'algosdk/dist/types/client/v2/algod/versions';
import { BaseHTTPClient } from 'algosdk/dist/types/client/baseHTTPClient';
import { AlgodTokenHeader, CustomTokenHeader } from 'algosdk/dist/types/client/urlTokenBaseHTTPClient';
import LightBlockHeaderProof from 'algosdk/dist/types/client/v2/algod/lightBlockHeaderProof';
import StateProof from 'algosdk/dist/types/client/v2/algod/stateproof';
/**
