import { Coins } from '@xpla/xpla.js/dist/core/Coins';
import { Int } from '@xpla/xpla.js/dist/core/numeric';
import { JSONSerializable } from '@xpla/xpla.js/dist/util/json';
import { CommunityPoolSpendProposal } from '@xpla/xpla.js/dist/core/distribution/proposals';
import { ParameterChangeProposal } from '@xpla/xpla.js/dist/core/params/proposals';
import { ClientUpdateProposal } from '@xpla/xpla.js/dist/core/ibc/proposals';
import { TextProposal } from '@xpla/xpla.js/dist/core/gov/proposals';
import { SoftwareUpgradeProposal, CancelSoftwareUpgradeProposal } from '@xpla/xpla.js/dist/core/upgrade/proposals';
import { ClearAdminProposal, ExecuteContractProposal, InstantiateContractProposal, MigrateContractProposal, PinCodesProposal, StoreCodeProposal, SudoContractProposal, UnpinCodesProposal, UpdateAdminProposal, UpdateInstantiateConfigProposal } from '@xpla/xpla.js/dist/core/wasm/proposals';
...
export declare namespace Proposal {
    ...
    namespace Content {
        type Amino = TextProposal.Amino | CommunityPoolSpendProposal.Amino | ParameterChangeProposal.Amino | SoftwareUpgradeProposal.Amino | CancelSoftwareUpgradeProposal.Amino | ClientUpdateProposal.Amino | ClearAdminProposal.Amino | ExecuteContractProposal.Amino | InstantiateContractProposal.Amino | MigrateContractProposal.Amino | PinCodesProposal.Amino | StoreCodeProposal.Amino | SudoContractProposal.Amino | UnpinCodesProposal.Amino | UpdateAdminProposal.Amino | UpdateInstantiateConfigProposal.Amino;
        type Data = TextProposal.Data | CommunityPoolSpendProposal.Data | ParameterChangeProposal.Data | SoftwareUpgradeProposal.Data | CancelSoftwareUpgradeProposal.Data | ClientUpdateProposal.Data | ClearAdminProposal.Data | ExecuteContractProposal.Data | InstantiateContractProposal.Data | MigrateContractProposal.Data | PinCodesProposal.Data | StoreCodeProposal.Data | SudoContractProposal.Data | UnpinCodesProposal.Data | UpdateAdminProposal.Data | UpdateInstantiateConfigProposal.Data;
