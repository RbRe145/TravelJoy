...
import { AccAddress } from '@xpla/xpla.js/dist/core/bech32';
...
export declare class MsgInstantiateContract extends JSONSerializable<MsgInstantiateContract.Amino, MsgInstantiateContract.Data, MsgInstantiateContract.Proto> {
    ...
    static fromAmino(data: MsgInstantiateContract.Amino, isClassic?: boolean): MsgInstantiateContract;
    toAmino(isClassic?: boolean): MsgInstantiateContract.Amino;
    static fromProto(proto: MsgInstantiateContract.Proto, isClassic?: boolean): MsgInstantiateContract;
    toProto(isClassic?: boolean): MsgInstantiateContract.Proto;
    packAny(isClassic?: boolean): Any;
    static unpackAny(msgAny: Any, isClassic?: boolean): MsgInstantiateContract;
    static fromData(data: MsgInstantiateContract.Data, isClassic?: boolean): MsgInstantiateContract;
    toData(isClassic?: boolean): MsgInstantiateContract.Data;
}
