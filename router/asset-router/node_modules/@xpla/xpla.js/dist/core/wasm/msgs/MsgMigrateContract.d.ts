...
export declare class MsgMigrateContract extends JSONSerializable<MsgMigrateContract.Amino, MsgMigrateContract.Data, MsgMigrateContract.Proto> {
    ...
    static fromAmino(data: MsgMigrateContract.Amino, isClassic?: boolean): MsgMigrateContract;
    toAmino(isClassic?: boolean): MsgMigrateContract.Amino;
    static fromProto(proto: MsgMigrateContract.Proto, isClassic?: boolean): MsgMigrateContract;
    toProto(isClassic?: boolean): MsgMigrateContract.Proto;
    packAny(isClassic?: boolean): Any;
    static unpackAny(msgAny: Any, isClassic?: boolean): MsgMigrateContract;
    static fromData(data: MsgMigrateContract.Data, isClassic?: boolean): MsgMigrateContract;
    toData(isClassic?: boolean): MsgMigrateContract.Data;
}
