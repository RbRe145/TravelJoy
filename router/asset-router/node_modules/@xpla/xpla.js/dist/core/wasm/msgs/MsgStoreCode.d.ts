...
import { AccessConfig } from '@xpla/xpla.js/dist/core/wasm/AccessConfig';
export declare class MsgStoreCode extends JSONSerializable<MsgStoreCode.Amino, MsgStoreCode.Data, MsgStoreCode.Proto> {
    ...
    static fromAmino(data: MsgStoreCode.AminoV2 | MsgStoreCode.AminoV1, isClassic?: boolean): MsgStoreCode;
    toAmino(isClassic?: boolean): MsgStoreCode.AminoV2;
    static fromProto(proto: MsgStoreCode.Proto, isClassic?: boolean): MsgStoreCode;
    toProto(isClassic?: boolean): MsgStoreCode.Proto;
    packAny(isClassic?: boolean): Any;
    static unpackAny(msgAny: Any, isClassic?: boolean): MsgStoreCode;
    static fromData(data: MsgStoreCode.DataV2 | MsgStoreCode.DataV1, isClassic?: boolean): MsgStoreCode;
    toData(isClassic?: boolean): MsgStoreCode.Data;
}
