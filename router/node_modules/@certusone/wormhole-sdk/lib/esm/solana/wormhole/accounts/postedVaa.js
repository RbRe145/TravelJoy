...
var PostedMessageData = /** @class */ (function () {
    function PostedMessageData(message) {
        this.message = message;
    }
    PostedMessageData.deserialize = function (data) {
        return new PostedMessageData(MessageData.deserialize(data.subarray(3)));
    };
    return PostedMessageData;
}());
export { PostedMessageData };
var PostedVaaData = /** @class */ (function (_super) {
    __extends(PostedVaaData, _super);
    function PostedVaaData() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return PostedVaaData;
}(PostedMessageData));
export { PostedVaaData };
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return PostedVaaData.deserialize(getAccountData(info)); })];
        });
    });
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return PostedMessageData.deserialize(getAccountData(info)); })];
        });
    });
}
