...
export function createTransferWrappedWithPayloadInstruction(tokenBridgeProgramId, wormholeProgramId, payer, message, from, fromOwner, tokenChain, tokenAddress, nonce, amount, targetAddress, targetChain, payload) {
    var methods = createReadOnlyTokenBridgeProgramInterface(tokenBridgeProgramId).methods.transferWrappedWithPayload(nonce, amount, Buffer.from(targetAddress), targetChain, Buffer.from(payload), null);
    // @ts-ignore
...
export function getTransferWrappedWithPayloadAccounts(tokenBridgeProgramId, wormholeProgramId, payer, message, from, fromOwner, tokenChain, tokenAddress, cpiProgramId) {
    var mint = deriveWrappedMintKey(tokenBridgeProgramId, tokenChain, tokenAddress);
