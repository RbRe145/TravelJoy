    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return TokenBridgeConfig.deserialize(getAccountData(info)); })];
        });
    });
}
var TokenBridgeConfig = /** @class */ (function () {
    function TokenBridgeConfig(wormholeProgramId) {
        this.wormhole = new PublicKey(wormholeProgramId);
    }
    TokenBridgeConfig.deserialize = function (data) {
        if (data.length != 32) {
            throw new Error("data.length != 32");
        }
        var wormholeProgramId = data.subarray(0, 32);
        return new TokenBridgeConfig(wormholeProgramId);
    };
    return TokenBridgeConfig;
}());
export { TokenBridgeConfig };
