...
export function createInitializeInstruction(nftBridgeProgramId, payer, wormholeProgramId) {
    var methods = createReadOnlyNftBridgeProgramInterface(nftBridgeProgramId).methods.initialize(wormholeProgramId);
    // @ts-ignore
