    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return WrappedMeta.deserialize(getAccountData(info)); })];
        });
    });
}
var WrappedMeta = /** @class */ (function () {
    function WrappedMeta(chain, tokenAddress, tokenId) {
        this.chain = chain;
        this.tokenAddress = tokenAddress;
        this.tokenId = tokenId;
    }
    WrappedMeta.deserialize = function (data) {
        if (data.length != 66) {
            throw new Error("data.length != 66");
        }
        var chain = data.readUInt16LE(0);
        var tokenAddress = data.subarray(2, 34);
        var tokenId = BigInt(new BN(data.subarray(34, 66), undefined, "le").toString());
