...
import { signSendAndConfirmTransaction, sendAndConfirmTransactionsWithRetry, modifySignTransaction, } from "./utils";
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, sendAndConfirmTransactionsWithRetry(connection, modifySignTransaction.apply(void 0, __spreadArray([signTransaction], __read(signers))), payer.toString(), unsignedTransactions, maxRetries)];
                case 2:
                    responses = _f.sent();
                    _c = 
                    ...
                    _d = [
                        ...
                        responses];
                    _e = [[]];
                    return [4 /*yield*/, sendAndConfirmTransactionsWithRetry(connection, signTransaction, payer.toString(), [postVaaTransaction], maxRetries)];
                case 3:
                    //While the signature_set is used to create the final instruction, it doesn't need to sign it.
...
export function postVaa(connection, signTransaction, wormholeProgramId, payer, vaa, options, asyncVerifySignatures) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_g) {
            switch (_g.label) {
                ...
                case 1:
                    ...
                    verifySignatures = function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            return [2 /*return*/, signSendAndConfirmTransaction(connection, payer, modifySignTransaction.apply(void 0, __spreadArray([signTransaction], __read(signers))), transaction, options)];
                        });
                    }); };
                    output = [];
                ...
                case 10:
                    _e = (_d = output).push;
                    return [4 /*yield*/, signSendAndConfirmTransaction(connection, payer, signTransaction, postVaaTransaction, options)];
                case 11:
                    _e.apply(_d, [_g.sent()]);
...
export function createPostSignedVaaTransactions(connection, wormholeProgramId, payer, vaa, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    parsed = isBytes(vaa) ? parseVaa(vaa) : vaa;
                    signatureSet = Keypair.generate();
                    return [4 /*yield*/, createVerifySignaturesInstructions(connection, wormholeProgramId, payer, parsed, signatureSet.publicKey, commitment)];
                case 1:
                    verifySignaturesInstructions = _b.sent();
                    unsignedTransactions = [];
                    for (i = 0; i < verifySignaturesInstructions.length; i += 2) {
                        unsignedTransactions.push((_a = new Transaction()).add.apply(_a, __spreadArray([], __read(verifySignaturesInstructions.slice(i, i + 2)))));
                    }
