...
import { CHAIN_ID_ALGORAND, CHAIN_ID_APTOS, CHAIN_ID_INJECTIVE, CHAIN_ID_NEAR, CHAIN_ID_OSMOSIS, CHAIN_ID_PYTHNET, CHAIN_ID_SOLANA, CHAIN_ID_SUI, CHAIN_ID_TERRA, CHAIN_ID_TERRA2, CHAIN_ID_WORMCHAIN, CHAIN_ID_UNSET, coalesceChainId, isEVMChain, isTerraChain, CHAIN_ID_XPLA, CHAIN_ID_BTC, } from "./consts";
...
export var tryHexToNativeStringNear = function (provider, tokenBridge, address) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, found, value;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, hashLookup(provider, tokenBridge, address)];
            case 1:
...
export function ensureHexPrefix(x) {
