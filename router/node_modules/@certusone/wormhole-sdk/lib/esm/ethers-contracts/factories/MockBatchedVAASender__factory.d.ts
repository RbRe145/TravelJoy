...
import type { MockBatchedVAASender, MockBatchedVAASenderInterface } from "../MockBatchedVAASender";
export declare class MockBatchedVAASender__factory extends ContractFactory {
    ...
    attach(address: string): MockBatchedVAASender;
    connect(signer: Signer): MockBatchedVAASender__factory;
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): MockBatchedVAASender;
}
