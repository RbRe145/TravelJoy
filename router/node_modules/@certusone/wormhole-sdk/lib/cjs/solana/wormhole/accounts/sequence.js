...
function deriveEmitterSequenceKey(emitter, wormholeProgramId) {
    return utils_1.deriveAddress([Buffer.from("Sequence"), new web3_js_1.PublicKey(emitter).toBytes()], wormholeProgramId);
}
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return SequenceTracker.deserialize(utils_1.getAccountData(info)); })];
        });
    });
}
exports.getSequenceTracker = getSequenceTracker;
var SequenceTracker = /** @class */ (function () {
    function SequenceTracker(sequence) {
        this.sequence = sequence;
    }
    SequenceTracker.deserialize = function (data) {
        if (data.length != 8) {
            throw new Error("data.length != 8");
        }
        return new SequenceTracker(data.readBigUInt64LE(0));
    };
    SequenceTracker.prototype.value = function () {
