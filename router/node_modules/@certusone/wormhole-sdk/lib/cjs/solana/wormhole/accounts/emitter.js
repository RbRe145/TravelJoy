...
function getEmitterKeys(emitterProgramId, wormholeProgramId) {
    var emitter = deriveWormholeEmitterKey(emitterProgramId);
    return {
        emitter: emitter,
...
function getProgramSequenceTracker(connection, emitterProgramId, wormholeProgramId, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, sequence_1.getSequenceTracker(connection, deriveWormholeEmitterKey(emitterProgramId), wormholeProgramId, commitment)];
        });
    });
}
