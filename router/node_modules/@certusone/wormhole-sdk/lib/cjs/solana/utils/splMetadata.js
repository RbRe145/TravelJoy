...
var SplTokenMetadataProgram = /** @class */ (function () {
    ...
    SplTokenMetadataProgram.createMetadataAccounts = function (payer, mint, mintAuthority, name, symbol, updateAuthority, updateAuthorityIsSigner, uri, creators, sellerFeeBasisPoints, isMutable, metadataAccount) {
        ...
        var keys = [
            account_1.newAccountMeta(metadataAccount, false),
            account_1.newReadOnlyAccountMeta(mint, false),
            account_1.newReadOnlyAccountMeta(mintAuthority, true),
            account_1.newReadOnlyAccountMeta(payer, true),
            account_1.newReadOnlyAccountMeta(updateAuthority, updateAuthorityIsSigner),
            account_1.newReadOnlyAccountMeta(web3_js_1.SystemProgram.programId, false),
            account_1.newReadOnlyAccountMeta(web3_js_1.SYSVAR_RENT_PUBKEY, false),
        ];
...
function deriveSplTokenMetadataKey(mint) {
    return account_1.deriveAddress([
...
function getMetadata(connection, mint, commitment) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    .getAccountInfo(deriveSplTokenMetadataKey(mint), commitment)
                    .then(function (info) { return Metadata.deserialize(account_1.getAccountData(info)); })];
        });
    });
}
