    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, connection
                    ...
                    .then(function (info) { return WrappedMeta.deserialize(utils_2.getAccountData(info)); })];
        });
    });
}
exports.getWrappedMeta = getWrappedMeta;
var WrappedMeta = /** @class */ (function () {
    function WrappedMeta(chain, tokenAddress, originalDecimals) {
        this.chain = chain;
    ...
    WrappedMeta.deserialize = function (data) {
        ...
        var originalDecimals = data.readUInt8(34);
