...
function createInitializeInstruction(nftBridgeProgramId, payer, wormholeProgramId) {
    var methods = program_1.createReadOnlyNftBridgeProgramInterface(nftBridgeProgramId).methods.initialize(wormholeProgramId);
    // @ts-ignore
