...
exports.humanAddress = exports.canonicalAddress = void 0;
...
function humanAddress(hrp, canonicalAddress) {
    return bech32_1.bech32.encode(hrp, bech32_1.bech32.toWords(canonicalAddress));
}
