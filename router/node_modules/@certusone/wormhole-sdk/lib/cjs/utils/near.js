...
var near_api_js_1 = __importDefault(require("near-api-js"));
var bn_js_1 = __importDefault(require("bn.js"));
function logNearGas(result, comment) {
    var _a = result.receipts_outcome.reduce(function (acc, receipt) {
    ...
    }), totalGasBurned = _a.totalGasBurned, totalTokensBurned = _a.totalTokensBurned;
...
function hashAccount(provider, tokenBridge, account) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, isRegistered, accountHash;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, callFunctionNear(provider, tokenBridge, "hash_account", { account: account })];
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 2]), isRegistered = _a[0], accountHash = _a[1];
                    return [2 /*return*/, {
...
function hashLookup(provider, tokenBridge, hash) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, callFunctionNear(provider, tokenBridge, "hash_lookup", {
                        hash: hash,
                    })];
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 2]), found = _a[0], value = _a[1];
                    return [2 /*return*/, {
                            found: found,
                            value: value,
                        }];
...
function callFunctionNear(provider, accountId, methodName, args) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, provider.query({
                ...
                case 1:
                    response = _a.sent();
                    return [2 /*return*/, JSON.parse(Buffer.from(response.result).toString())];
            }
        });
    });
}
