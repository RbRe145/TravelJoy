...
var ETHEREUM_CORE_BRIDGE = consts_1.CONTRACTS["MAINNET"].ethereum.core;
function hex(x) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    core = ethers_contracts_1.Implementation__factory.connect(ETHEREUM_CORE_BRIDGE, provider);
...
function repairVaa(vaaHex, guardianSetData) {
    ...
    var parsedVaa = vaa_1.parseVaa(array_1.hexToUint8Array(vaaHex));
    var numSignatures = parsedVaa.guardianSignatures.length;
    var digest = utils_1.keccak256(parsedVaa.hash).toString("hex");
    var validSignatures = [];
    ...
    parsedVaa.guardianSignatures.forEach(function (signature) {
        try {
            var vaaGuardianPublicKey = ethers_1.ethers.utils.recoverAddress(hex(digest), hex(signature.signature.toString("hex")));
