...
var MockTokenBridge = /** @class */ (function (_super) {
    ...
    MockTokenBridge.prototype.serializeTransferOnly = function (withPayload, tokenAddress, tokenChain, amount, recipientChain, recipient, fee, fromAddress) {
        ...
        var amountBytes = new anchor_1.BN(amount.toString()).toBuffer();
        ...
        if (withPayload) {
            ...
            var feeBytes = new anchor_1.BN(fee.toString()).toBuffer();
...
var MockEthereumTokenBridge = /** @class */ (function (_super) {
    ...
    function MockEthereumTokenBridge(emitterAddress, startSequence) {
        var _this = this;
        var chain = 2;
        _this = _super.call(this, utils_1.tryNativeToHexString(emitterAddress, chain), chain, 15, startSequence) || this;
        return _this;
    }
    MockEthereumTokenBridge.prototype.publishAttestMeta = function (tokenAddress, decimals, symbol, name, nonce, timestamp, uptickSequence) {
        if (uptickSequence === void 0) { uptickSequence = true; }
        return _super.prototype.publishAttestMeta.call(this, utils_1.tryNativeToHexString(tokenAddress, this.chain), decimals, symbol == undefined ? "" : symbol, name == undefined ? "" : name, nonce, timestamp, uptickSequence);
    };
...
var MockSolanaTokenBridge = /** @class */ (function (_super) {
    ...
    function MockSolanaTokenBridge(emitterAddress) {
        return _super.call(this, new web3_js_1.PublicKey(emitterAddress).toBuffer().toString("hex"), 1, 32) || this;
    }
    MockSolanaTokenBridge.prototype.publishAttestMeta = function (mint, decimals, symbol, name, nonce, timestamp, uptickSequence) {
        if (uptickSequence === void 0) { uptickSequence = true; }
        return _super.prototype.publishAttestMeta.call(this, new web3_js_1.PublicKey(mint).toBuffer().toString("hex"), decimals, symbol == undefined ? "" : symbol, name == undefined ? "" : name, nonce, timestamp, uptickSequence);
    };
