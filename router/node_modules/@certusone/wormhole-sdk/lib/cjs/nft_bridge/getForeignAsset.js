...
exports.getForeignAssetAptos = exports.getForeignAssetSol = exports.getForeignAssetSolana = exports.getForeignAssetTerra = exports.getForeignAssetEth = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    tokenBridge = ethers_contracts_1.NFTBridge__factory.connect(nftBridgeAddress, provider);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 5, , 6]);
 ...
 * @returns
 */
function getForeignAssetTerra(nftBridgeAddress, client, originChain, originAsset) {
    return __awaiter(this, void 0, void 0, function () {
...
function getForeignAssetSolana(nftBridgeAddress, originChain, originAsset, tokenId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, nftBridge_1.deriveWrappedMintKey(nftBridgeAddress, utils_2.coalesceChainId(originChain), originAsset, utils_1.isBytes(tokenId) ? BigInt(new anchor_1.BN(tokenId).toString()) : tokenId).toString()];
        });
    });
}
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (originChainId === utils_2.CHAIN_ID_APTOS) {
                        return [2 /*return*/, utils_2.getTokenIdFromTokenHash(client, nftBridgeAddress, originAddress)];
                    }
                    return [4 /*yield*/, utils_2.deriveResourceAccountAddress(nftBridgeAddress, originChainId, originAddress)];
                case 1:
                ...
                case 2:
                    ...
                    event = events.find(function (e) {
                        return utils_2.ensureHexPrefix(e.data.id.name) ===
                ...
                case 3:
                    _a.trys.push([3, 5, , 6]);
                    tokenIdObj = {
                        token_data_id: __assign(__assign({}, events[0].data.id), { name: aptos_1.HexString.fromUint8Array(tokenIdAsUint8Array).noPrefix() }),
                        property_version: "0",
                    };
                    return [4 /*yield*/, new aptos_1.TokenClient(client).getTokenData(tokenIdObj.token_data_id.creator, tokenIdObj.token_data_id.collection, tokenIdObj.token_data_id.name)];
                case 4:
                    _a.sent();
                    return [2 /*return*/, tokenIdObj];
                case 5:
                    e_3 = _a.sent();
                    if (e_3 instanceof aptos_1.ApiError &&
                        e_3.status === 404 &&
