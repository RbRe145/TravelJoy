...
var algosdk_2 = __importDefault(require("algosdk"));
var ethers_1 = require("ethers");
var utils_1 = require("ethers/lib/utils");
var bridge_1 = require("../bridge");
var utils_2 = require("../utils");
var bigint_1 = require("../utils/bigint");
var TmplSig_1 = require("./TmplSig");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    ts = new TmplSig_1.TmplSig(client);
...
function optin(client, senderAddr, appId, appIndex, emitterId) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    appAddr = algosdk_1.getApplicationAddress(appId);
                ...
                case 2:
                    params = _b.sent();
                    seedTxn = algosdk_1.makePaymentTxnWithSuggestedParamsFromObject({
                        from: senderAddr,
                        to: sigAddr,
                        amount: SEED_AMT,
                    ...
                    optinTxn = algosdk_1.makeApplicationOptInTxnFromObject({
                        from: sigAddr,
                        suggestedParams: params,
                    ...
                    txs.push({
                        ...
                        signer: {
                            ...
                            signTxn: function (txn) {
                                return Promise.resolve(algosdk_1.signLogicSigTransaction(txn, lsa).blob);
                            },
                        },
                    });
...
function _parseNFTAlgorand(vaa) {
    var ret = _parseVAAAlgorand(vaa);
    var arr = Buffer.from(ret.Body);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    seq = parsedVAA.sequence / BigInt(exports.MAX_BITS);
                    chainRaw = parsedVAA.chainRaw;
                    em = parsedVAA.emitter;
                    index = parsedVAA.index;
                    txs = [];
                ...
                case 1:
                    ...
                    guardianPgmName = utils_2.textToHexString("guardian");
                ...
                case 4:
                    params = _c.sent();
                    digest = utils_1.keccak256(utils_1.keccak256(parsedVAA.digest)).slice(2);
                    numSigs = parsedVAA.siglen;
                    numTxns = Math.floor(numSigs / MAX_SIGS_PER_TXN) + 1;
                    SIG_LEN = 66;
                    BSIZE = SIG_LEN * MAX_SIGS_PER_TXN;
                    signatures = parsedVAA.signatures;
                    verifySigArg = utils_2.textToUint8Array("verifySigs");
                    lsa = new algosdk_1.LogicSigAccount(ALGO_VERIFY);
                    for (nt = 0; nt < numTxns; nt++) {
                        ...
                        appTxn_1 = algosdk_1.makeApplicationCallTxnFromObject({
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    if (!(parsedVAA.Meta === "CoreGovernance" &&
                        parsedVAA.action === 2 &&
                        parsedVAA.NewGuardianSetIndex !== undefined)) return [3 /*break*/, 3];
                    ngsi = parsedVAA.NewGuardianSetIndex;
                    guardianPgmName = utils_2.textToHexString("guardian");
                    return [4 /*yield*/, optin(client, senderAddr, bridgeId, BigInt(ngsi), guardianPgmName)];
                case 2:
                ...
                case 3:
                    ...
                    if (!((meta === "TokenBridge Attest" ||
                        ...
                        parsedVAA.Contract !== undefined)) return [3 /*break*/, 8];
                    if (!(parsedVAA.FromChain !== utils_2.CHAIN_ID_ALGORAND && parsedVAA.FromChain)) return [3 /*break*/, 5];
                    return [4 /*yield*/, optin(client, senderAddr, tokenBridgeId, BigInt(parsedVAA.FromChain), parsedVAA.Contract)];
                case 4:
                    result = _b.sent();
                    ...
                    return [3 /*break*/, 7];
                case 5:
                    assetId = hexToNativeAssetBigIntAlgorand(parsedVAA.Contract);
                    return [4 /*yield*/, optin(client, senderAddr, tokenBridgeId, assetId, utils_2.textToHexString("native"))];
                case 6:
                    result = _b.sent();
                    chainAddr = result.addr;
                    txs.unshift.apply(txs, __spreadArray([], __read(result.txs)));
                ...
                case 11:
                    if (!((meta === "TokenBridge Transfer" ||
                        meta === "TokenBridge Transfer With Payload") &&
                        parsedVAA.Contract !== undefined)) return [3 /*break*/, 17];
                    foreignAssets = [];
                    a = 0;
                    if (!(parsedVAA.FromChain !== utils_2.CHAIN_ID_ALGORAND)) return [3 /*break*/, 13];
                    return [4 /*yield*/, decodeLocalState(client, tokenBridgeId, chainAddr)];
                case 12:
                    asset = _b.sent();
                    if (asset.length > 8) {
                ...
                case 16:
                    ...
                    if (meta === "TokenBridge Transfer With Payload") {
                        ...
                        m = algosdk_2.default.ABIMethod.fromSignature("portal_transfer(byte[])byte[]");
                        txs.push({
                            tx: algosdk_1.makeApplicationCallTxnFromObject({
                                appArgs: [
                                    m.getSelector(),
...
function signSendAndConfirmAlgorand(algodClient, txs, wallet) {
    return __awaiter(this, void 0, void 0, function () {
        var signedTxns, txs_1, txs_1_1, tx, _a, _b, e_4_1, result;
        var e_4, _c;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    algosdk_1.assignGroupID(txs.map(function (tx) { return tx.tx; }));
                    signedTxns = [];
                    _d.label = 1;
                case 1:
                    ...
                    _d.label = 2;
                case 2:
                    if (!!txs_1_1.done) return [3 /*break*/, 6];
                    tx = txs_1_1.value;
                    if (!tx.signer) return [3 /*break*/, 4];
                    _b = (_a = signedTxns).push;
                    return [4 /*yield*/, tx.signer.signTxn(tx.tx)];
                case 3:
                    _b.apply(_a, [_d.sent()]);
                    return [3 /*break*/, 5];
                case 4:
                ...
                case 8:
                    try {
                        if (txs_1_1 && !txs_1_1.done && (_c = txs_1.return)) _c.call(txs_1);
                    }
                    finally { if (e_4) throw e_4.error; }
                    return [7 /*endfinally*/];
                case 9: return [4 /*yield*/, algodClient.sendRawTransaction(signedTxns).do()];
                case 10:
                    _d.sent();
                    return [4 /*yield*/, algosdk_1.waitForConfirmation(algodClient, txs[txs.length - 1].tx.txID(), 4)];
                case 11:
                    result = _d.sent();
