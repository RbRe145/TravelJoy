...
function _parseEip712Signature(tx, fields, _serialize) {
    try {
...
function checkSignatureType(rawTransaction) {
    ...
    return logger_2.logger.throwError(`unsupported transaction type: ${payload[0]}, please use legacy or EIP-712 instead. More info about EVM+ gas: https://evmdocs.acala.network/network/gas-parameters`, logger_1.Logger.errors.UNSUPPORTED_OPERATION, {
