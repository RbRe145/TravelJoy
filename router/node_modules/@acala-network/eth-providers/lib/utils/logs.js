...
exports.TX_RECEIPT_NODES = exports.LOGS_NODES = exports.adaptLogs = exports.buildLogsGqlFilter = exports.filterLog = exports.filterLogByAddress = exports.filterLogByTopics = void 0;
...
/* --------------- log utils for Subql --------------- */
/* --------------------------------------------------- */
const _isEffectiveFilter = (x) => x !== undefined && x !== null && !(Array.isArray(x) && x.length === 0);
const _isAnyFilterEffective = (arr) => arr.some((a) => _isEffectiveFilter(a));
const _buildBlockNumberGqlFilter = (fromBlock, toBlock) => {
...
const _buildAddressGqlFilter = (address) => address ? `address: { inInsensitive: ${JSON.stringify(Array.isArray(address) ? address : [address])}}` : '';
const buildLogsGqlFilter = (filter) => {
...
exports.buildLogsGqlFilter = buildLogsGqlFilter;
