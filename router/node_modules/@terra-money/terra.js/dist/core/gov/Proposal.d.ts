...
import { Int } from '@terra-money/terra.js/dist/core/numeric';
import { JSONSerializable } from '@terra-money/terra.js/dist/util/json';
import { CommunityPoolSpendProposal } from '@terra-money/terra.js/dist/core/distribution/proposals';
import { ParameterChangeProposal } from '@terra-money/terra.js/dist/core/params/proposals';
import { ClientUpdateProposal } from '@terra-money/terra.js/dist/core/ibc/proposals';
import { TextProposal } from '@terra-money/terra.js/dist/core/gov/proposals';
import { SoftwareUpgradeProposal, CancelSoftwareUpgradeProposal } from '@terra-money/terra.js/dist/core/upgrade/proposals';
import { ClearAdminProposal, ExecuteContractProposal, InstantiateContractProposal, MigrateContractProposal, PinCodesProposal, StoreCodeProposal, SudoContractProposal, UnpinCodesProposal, UpdateAdminProposal, UpdateInstantiateConfigProposal } from '@terra-money/terra.js/dist/core/wasm/proposals';
